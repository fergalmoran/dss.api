...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Playlist.public'
        db.add_column(u'spa_playlist', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Playlist.public'
        db.delete_column(u'spa_playlist', 'public')
    ...
    models = {
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 2, 0, 0)'}),

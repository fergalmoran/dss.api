...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('spa_notification', 'notification_text')

        # Deleting field 'Notification.notification_html'
        db.delete_column('spa_notification', 'notification_html')

        # Deleting field 'Notification.notification_url'
        db.delete_column('spa_notification', 'notification_url')

        # Adding field 'Notification.type'
        db.add_column('spa_notification', 'type',
    ...
    def backwards(self, orm):
        ...
        db.add_column('spa_notification', 'notification_text',
        ...
        db.add_column('spa_notification', 'notification_html',
                      self.gf('django.db.models.fields.CharField')(max_length=1024),
                      keep_default=False)

        # Adding field 'Notification.notification_url'
        db.add_column('spa_notification', 'notification_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)

        # Deleting field 'Notification.type'
        db.delete_column('spa_notification', 'type')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserMixFavourite'
        db.create_table('spa_usermixfavourite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mix', self.gf('django.db.models.fields.related.ForeignKey')(related_name='favourites', to=orm['spa.Mix'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='users', to=orm['spa.UserProfile'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('spa', ['UserMixFavourite'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'UserMixFavourite'
        db.delete_table('spa_usermixfavourite')
    ...
    models = {
        ...
        'spa._activity': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'activity'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'spa._lookup': {
        ...
        'spa.usermixfavourite': {
            'Meta': {'object_name': 'UserMixFavourite'},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mix': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'favourites'", 'to': "orm['spa.Mix']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'users'", 'to': "orm['spa.UserProfile']"})
        },
        'spa.userprofile': {

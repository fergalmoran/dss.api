...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('spa_mix', 'title', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Mix.title'
        db.alter_column('spa_mix', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('spa_playlist_mixes')
    ...
    def backwards(self, orm):
        ...
        db.delete_table('spa_playlist')

        # Removing M2M table for field mixes on 'Playlist'
        db.delete_table(db.shorten_name('spa_playlist_mixes'))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'spa_playlist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='playlists', to=orm['spa.UserProfile'])),
        ))
        db.send_create_signal('spa', ['Playlist'])

        # Adding M2M table for field mixes on 'Playlist'
        m2m_table_name = db.shorten_name(u'spa_playlist_mixes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('playlist', models.ForeignKey(orm['spa.playlist'], null=False)),
            ('mix', models.ForeignKey(orm['spa.mix'], null=False))
        ))
        db.create_unique(m2m_table_name, ['playlist_id', 'mix_id'])


    def backwards(self, orm):
        # Deleting model 'Playlist'
        db.delete_table(u'spa_playlist')

        # Removing M2M table for field mixes on 'Playlist'
        db.delete_table(db.shorten_name(u'spa_playlist_mixes'))
    ...
    models = {
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 27, 0, 0)'}),

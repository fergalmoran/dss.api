...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('spa_userprofile', 'activity_sharing')

        # Adding field 'UserProfile.activity_sharing_facebook'
        db.add_column('spa_userprofile', 'activity_sharing_facebook',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'UserProfile.activity_sharing_twitter'
        db.add_column('spa_userprofile', 'activity_sharing_twitter',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('spa_userprofile', 'activity_sharing',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'UserProfile.activity_sharing_facebook'
        db.delete_column('spa_userprofile', 'activity_sharing_facebook')

        # Deleting field 'UserProfile.activity_sharing_twitter'
        db.delete_column('spa_userprofile', 'activity_sharing_twitter')

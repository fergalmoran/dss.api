...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('spa_userprofile', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
        # Adding index on 'UserProfile', fields ['slug']
        db.create_index('spa_userprofile', ['slug'])


    def backwards(self, orm):
        # Removing index on 'UserProfile', fields ['slug']
        db.delete_index('spa_userprofile', ['slug'])


        # Changing field 'UserProfile.slug'
        db.alter_column('spa_userprofile', 'slug', self.gf('django.db.models.fields.CharField')(max_length=35, null=True))

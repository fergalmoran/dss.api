...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mix.waveform_version'
        db.add_column(u'spa_mix', 'waveform_version',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mix.waveform_version'
        db.delete_column(u'spa_mix', 'waveform_version')
    ...
    models = {
        ...
        'spa._lookup': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'object_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 10, 0, 0)', 'auto_now': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        'spa.activity': {
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 10, 0, 0)'}),

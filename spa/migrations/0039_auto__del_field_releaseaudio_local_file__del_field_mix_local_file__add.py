...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('spa_releaseaudio', 'local_file')

        # Deleting field 'Mix.local_file'
        db.delete_column('spa_mix', 'local_file')

        # Adding field 'Mix.filetype'
        db.add_column('spa_mix', 'filetype',
    ...
    def backwards(self, orm):
        ...
        db.add_column('spa_releaseaudio', 'local_file',

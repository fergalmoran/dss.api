...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ReleaseAudio.local_file'
        db.delete_column(u'spa_releaseaudio', 'local_file')

        # Deleting field 'Mix.local_file'
        db.delete_column(u'spa_mix', 'local_file')

        # Adding field 'Mix.filetype'
        db.add_column(u'spa_mix', 'filetype',
                      self.gf('django.db.models.fields.CharField')(default='mp3', max_length=10),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ReleaseAudio.local_file'
        raise RuntimeError("Cannot reverse this migration. 'ReleaseAudio.local_file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ReleaseAudio.local_file'
        db.add_column(u'spa_releaseaudio', 'local_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Mix.local_file'
        raise RuntimeError("Cannot reverse this migration. 'Mix.local_file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Mix.local_file'
        db.add_column(u'spa_mix', 'local_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'Mix.filetype'
        db.delete_column(u'spa_mix', 'filetype')
    ...
    models = {
        ...
        'spa.event': {
            ...
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 4, 0, 0)'}),
            'event_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 4, 0, 0)'}),
            ...
            'event_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 1, 4, 0, 0)'}),
        ...
        'spa.mix': {
            ...
            'upload_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 4, 0, 0)'}),
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 4, 0, 0)'}),

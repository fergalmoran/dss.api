...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('spa_userprofile', 'followers_id')

        # Deleting field 'UserProfile.following'
        db.delete_column('spa_userprofile', 'following_id')
        ...
        db.create_table('spa_userprofile_following', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_userprofile', models.ForeignKey(orm['spa.userprofile'], null=False)),
            ('to_userprofile', models.ForeignKey(orm['spa.userprofile'], null=False))
        ))
        db.create_unique('spa_userprofile_following', ['from_userprofile_id', 'to_userprofile_id'])


    def backwards(self, orm):
        # Adding field 'UserProfile.followers'
        db.add_column('spa_userprofile', 'followers',
        ...
        db.add_column('spa_userprofile', 'following',

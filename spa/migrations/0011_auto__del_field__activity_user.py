...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('spa__activity', 'user_id')


    def backwards(self, orm):
        # Adding field '_Activity.user'
        db.add_column('spa__activity', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='favourites', null=True, to=orm['auth.User']),
                      keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Show'
        db.delete_table('spa_show')


    def backwards(self, orm):
        # Adding model 'Show'
        db.create_table('spa_show', (
            ('mix', self.gf('django.db.models.fields.related.ForeignKey')(related_name='show', to=orm['spa.Mix'])),
    ...
    models = {
        ...
        'spa._lookup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 30, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'object_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 30, 0, 0)', 'auto_now': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        'spa.activity': {
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 4, 30, 0, 0)'}),

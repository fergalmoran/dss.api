...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('spa_userprofile_favourites', (
        ...
        db.create_unique('spa_userprofile_favourites', ['from_userprofile_id', 'to_userprofile_id'])
    ...
    models = {
        ...
        'spa._activity': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'favourites'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'spa._lookup': {
        ...
        'spa.userprofile': {
            ...
            'favourites': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'favourites_rel_+'", 'null': 'True', 'to': "orm['spa.UserProfile']"}),

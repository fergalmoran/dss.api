...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mix.upload_date'
        db.alter_column(u'spa_mix', 'upload_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Mix.upload_date'
        db.alter_column(u'spa_mix', 'upload_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 1, 0, 0)'}),

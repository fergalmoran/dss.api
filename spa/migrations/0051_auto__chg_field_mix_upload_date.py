...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('spa_mix', 'upload_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Mix.upload_date'
        db.alter_column('spa_mix', 'upload_date', self.gf('django.db.models.fields.DateTimeField')())

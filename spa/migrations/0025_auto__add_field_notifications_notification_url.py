...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notifications.notification_url'
        db.add_column(u'spa_notifications', 'notification_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notifications.notification_url'
        db.delete_column(u'spa_notifications', 'notification_url')

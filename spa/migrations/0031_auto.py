...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field favourites on 'Mix'
        db.create_table(u'spa_mix_favourites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('mix', models.ForeignKey(orm['spa.mix'], null=False)),
            ('userprofile', models.ForeignKey(orm['spa.userprofile'], null=False))
        ))
        db.create_unique(u'spa_mix_favourites', ['mix_id', 'userprofile_id'])


    def backwards(self, orm):
        # Removing M2M table for field favourites on 'Mix'
        db.delete_table('spa_mix_favourites')
    ...
    models = {
        ...
        'spa.event': {
            ...
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 21, 0, 0)'}),
            'event_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 21, 0, 0)'}),
            ...
            'event_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 7, 21, 0, 0)'}),
        ...
        'spa.mix': {
            ...
            'favourites': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['spa.UserProfile']", 'symmetrical': 'False'}),
            ...
            'upload_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 21, 0, 0)'}),
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 21, 0, 0)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mix.download_url'
        db.delete_column(u'spa_mix', 'download_url')

        # Deleting field 'Mix.stream_url'
        db.delete_column(u'spa_mix', 'stream_url')


    def backwards(self, orm):
        # Adding field 'Mix.download_url'
        db.add_column(u'spa_mix', 'download_url',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)

        # Adding field 'Mix.stream_url'
        db.add_column(u'spa_mix', 'stream_url',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)
    ...
    models = {
        ...
        'spa.mix': {
            ...
            'favourites': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['spa.UserProfile']", 'null': 'True', 'blank': 'True'}),
            ...
            'upload_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 22, 0, 0)'}),
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 22, 0, 0)'}),

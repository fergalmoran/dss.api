...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('spa_userprofile', 'notifications_list')

        # Removing M2M table for field likes on 'Comment'
        db.delete_table(db.shorten_name('spa_comment_likes'))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.notifications_list'
        db.add_column(u'spa_userprofile', 'notifications_list',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding M2M table for field likes on 'Comment'
        m2m_table_name = db.shorten_name(u'spa_comment_likes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('comment', models.ForeignKey(orm['spa.comment'], null=False)),
            ('userprofile', models.ForeignKey(orm['spa.userprofile'], null=False))
        ))
        db.create_unique(m2m_table_name, ['comment_id', 'userprofile_id'])


    def backwards(self, orm):
        # Deleting field 'UserProfile.notifications_list'
        db.delete_column(u'spa_userprofile', 'notifications_list')

        # Removing M2M table for field likes on 'Comment'
        db.delete_table(db.shorten_name(u'spa_comment_likes'))
    ...
    models = {
        ...
        'spa._lookup': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 29, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'object_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 29, 0, 0)', 'auto_now': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        'spa.activity': {
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 29, 0, 0)'}),
        ...
        'spa.userprofile': {
            ...
            'notifications_list': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'object_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 29, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'object_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 29, 0, 0)', 'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Playlist.date_created'
        db.alter_column(u'spa_playlist', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Activity.date'
        db.alter_column(u'spa_activity', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Comment.date_created'
        db.alter_column(u'spa_comment', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Notification.date'
        db.alter_column(u'spa_notification', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Playlist.date_created'
        db.alter_column(u'spa_playlist', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Activity.date'
        db.alter_column(u'spa_activity', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Comment.date_created'
        db.alter_column(u'spa_comment', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Notification.date'
        db.alter_column(u'spa_notification', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

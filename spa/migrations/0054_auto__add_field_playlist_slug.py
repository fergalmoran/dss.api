...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'spa_playlist', 'slug',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'spa_playlist', 'slug')
    ...
    models = {
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 14, 0, 0)'}),

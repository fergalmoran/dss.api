...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.last_known_session'
        db.add_column(u'spa_userprofile', 'last_known_session',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.last_known_session'
        db.delete_column(u'spa_userprofile', 'last_known_session')
    ...
    models = {
        ...
        'spa.event': {
            ...
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 8, 0, 0)'}),
            'event_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 8, 0, 0)'}),
            ...
            'event_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 10, 8, 0, 0)'}),
        ...
        'spa.mix': {
            ...
            'upload_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 8, 0, 0)'}),
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 10, 8, 0, 0)'}),

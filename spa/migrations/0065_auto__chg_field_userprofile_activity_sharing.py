...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('spa_userprofile', 'activity_sharing', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'UserProfile.activity_sharing'
        db.alter_column('spa_userprofile', 'activity_sharing', self.gf('django.db.models.fields.IntegerField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('spa_mix', 'mix_image', self.gf('django.db.models.fields.files.ImageField')(max_length=1024))

        # Changing field 'UserProfile.avatar_image'
        db.alter_column('spa_userprofile', 'avatar_image', self.gf('django.db.models.fields.files.ImageField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Mix.mix_image'
        db.alter_column('spa_mix', 'mix_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'UserProfile.avatar_image'
        db.alter_column('spa_userprofile', 'avatar_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('spa_label', 'object_created',
        ...
        db.add_column('spa_label', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Mix.object_created'
        db.add_column('spa_mix', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Mix.object_updated'
        db.add_column('spa_mix', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Mix.mp3tags_updated'
        db.add_column('spa_mix', 'mp3tags_updated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Tracklist.object_created'
        db.add_column('spa_tracklist', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Tracklist.object_updated'
        db.add_column('spa_tracklist', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'ReleaseAudio.object_created'
        db.add_column('spa_releaseaudio', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'ReleaseAudio.object_updated'
        db.add_column('spa_releaseaudio', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Genre.object_created'
        db.add_column('spa_genre', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Genre.object_updated'
        db.add_column('spa_genre', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.object_created'
        db.add_column('spa_userprofile', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.object_updated'
        db.add_column('spa_userprofile', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Venue.object_created'
        db.add_column('spa_venue', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Venue.object_updated'
        db.add_column('spa_venue', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field '_Lookup.object_created'
        db.add_column('spa__lookup', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field '_Lookup.object_updated'
        db.add_column('spa__lookup', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Activity.object_created'
        db.add_column('spa_activity', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Activity.object_updated'
        db.add_column('spa_activity', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Release.object_created'
        db.add_column('spa_release', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Release.object_updated'
        db.add_column('spa_release', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'PurchaseLink.object_created'
        db.add_column('spa_purchaselink', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'PurchaseLink.object_updated'
        db.add_column('spa_purchaselink', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'ChatMessage.object_created'
        db.add_column('spa_chatmessage', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'ChatMessage.object_updated'
        db.add_column('spa_chatmessage', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Comment.object_created'
        db.add_column('spa_comment', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Comment.object_updated'
        db.add_column('spa_comment', 'object_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Notification.object_created'
        db.add_column('spa_notification', 'object_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 11, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('spa_label', 'object_created')

        # Deleting field 'Label.object_updated'
        db.delete_column('spa_label', 'object_updated')

        # Deleting field 'Mix.object_created'
        db.delete_column('spa_mix', 'object_created')

        # Deleting field 'Mix.object_updated'
        db.delete_column('spa_mix', 'object_updated')

        # Deleting field 'Mix.mp3tags_updated'
        db.delete_column('spa_mix', 'mp3tags_updated')

        # Deleting field 'Tracklist.object_created'
        db.delete_column('spa_tracklist', 'object_created')

        # Deleting field 'Tracklist.object_updated'
        db.delete_column('spa_tracklist', 'object_updated')

        # Deleting field 'ReleaseAudio.object_created'
        db.delete_column('spa_releaseaudio', 'object_created')

        # Deleting field 'ReleaseAudio.object_updated'
        db.delete_column('spa_releaseaudio', 'object_updated')

        # Deleting field 'Genre.object_created'
        db.delete_column('spa_genre', 'object_created')

        # Deleting field 'Genre.object_updated'
        db.delete_column('spa_genre', 'object_updated')

        # Deleting field 'UserProfile.object_created'
        db.delete_column('spa_userprofile', 'object_created')

        # Deleting field 'UserProfile.object_updated'
        db.delete_column('spa_userprofile', 'object_updated')

        # Deleting field 'Venue.object_created'
        db.delete_column('spa_venue', 'object_created')

        # Deleting field 'Venue.object_updated'
        db.delete_column('spa_venue', 'object_updated')

        # Deleting field '_Lookup.object_created'
        db.delete_column('spa__lookup', 'object_created')

        # Deleting field '_Lookup.object_updated'
        db.delete_column('spa__lookup', 'object_updated')

        # Deleting field 'Activity.object_created'
        db.delete_column('spa_activity', 'object_created')

        # Deleting field 'Activity.object_updated'
        db.delete_column('spa_activity', 'object_updated')

        # Deleting field 'Release.object_created'
        db.delete_column('spa_release', 'object_created')

        # Deleting field 'Release.object_updated'
        db.delete_column('spa_release', 'object_updated')

        # Deleting field 'PurchaseLink.object_created'
        db.delete_column('spa_purchaselink', 'object_created')

        # Deleting field 'PurchaseLink.object_updated'
        db.delete_column('spa_purchaselink', 'object_updated')

        # Deleting field 'ChatMessage.object_created'
        db.delete_column('spa_chatmessage', 'object_created')

        # Deleting field 'ChatMessage.object_updated'
        db.delete_column('spa_chatmessage', 'object_updated')

        # Deleting field 'Comment.object_created'
        db.delete_column('spa_comment', 'object_created')

        # Deleting field 'Comment.object_updated'
        db.delete_column('spa_comment', 'object_updated')

        # Deleting field 'Notification.object_created'
        db.delete_column('spa_notification', 'object_created')
    ...
    models = {
        ...
        'spa._lookup': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'object_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 11, 0, 0)', 'auto_now': 'True', 'db_index': 'True', 'blank': 'True'})
        },
        'spa.activity': {
        ...
        'spa.event': {
            ...
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 11, 0, 0)'}),
            'event_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 11, 0, 0)'}),
            ...
            'event_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 3, 11, 0, 0)'}),
        ...
        'spa.mix': {
            ...
            'upload_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 11, 0, 0)'}),
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 11, 0, 0)'}),

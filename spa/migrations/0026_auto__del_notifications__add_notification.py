...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('spa_notifications')

        # Adding model 'Notification'
        db.create_table('spa_notification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='to_notications', to=orm['spa.UserProfile'])),
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notifications', null=True, to=orm['spa.UserProfile'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('notification_text', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('notification_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
        ))
        db.send_create_signal('spa', ['Notification'])


    def backwards(self, orm):
        # Adding model 'Notifications'
        db.create_table('spa_notifications', (
            ('notification_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
            ('notification_text', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='to_notications', to=orm['spa.UserProfile'])),
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', null=True, to=orm['spa.UserProfile'], blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('spa', ['Notifications'])

        # Deleting model 'Notification'
        db.delete_table('spa_notification')
    ...
    models = {
        ...
        'spa.activityfollow': {
            ...
            'activity_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['spa.Activity']", 'unique': 'True', 'primary_key': 'True'}),
            'to_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'follower_activity'", 'to': "orm['spa.UserProfile']"})
        },
        'spa.activitylike': {
        ...
        'spa.event': {
            ...
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 14, 0, 0)'}),
            'event_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 14, 0, 0)'}),
            ...
            'event_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 7, 14, 0, 0)'}),
        ...
        'spa.mix': {
            ...
            'upload_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 14, 0, 0)'}),
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 14, 0, 0)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.accepted_date'
        db.add_column(u'spa_notification', 'accepted_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.accepted_date'
        db.delete_column(u'spa_notification', 'accepted_date')

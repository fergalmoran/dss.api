...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.verb'
        db.add_column(u'spa_notification', 'verb',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Notification.object'
        db.add_column(u'spa_notification', 'object',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.verb'
        db.delete_column(u'spa_notification', 'verb')

        # Deleting field 'Notification.object'
        db.delete_column(u'spa_notification', 'object')
    ...
    models = {
        ...
        'spa.notification': {
            ...
            'object': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'}),

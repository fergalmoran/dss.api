...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('spa_notification', 'verb')

        # Deleting field 'Notification.object'
        db.delete_column('spa_notification', 'object')

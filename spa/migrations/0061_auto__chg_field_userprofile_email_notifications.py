...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('spa_userprofile', 'email_notifications', self.gf('spa.models.fields.MultiSelectField')(max_length=104))

    def backwards(self, orm):

        # Changing field 'UserProfile.email_notifications'
        db.alter_column('spa_userprofile', 'email_notifications', self.gf('django.db.models.fields.BigIntegerField')())

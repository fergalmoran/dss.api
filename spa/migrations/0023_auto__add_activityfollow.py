...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityFollow'
        db.create_table(u'spa_activityfollow', (
            (u'activity_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['spa.Activity'], unique=True, primary_key=True)),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='follower_activity', to=orm['spa.UserProfile'])),
        ))
        db.send_create_signal('spa', ['ActivityFollow'])


    def backwards(self, orm):
        # Deleting model 'ActivityFollow'
        db.delete_table(u'spa_activityfollow')
    ...
    models = {
        ...
        'spa.event': {
            ...
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 12, 0, 0)'}),
            'event_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 12, 0, 0)'}),
            ...
            'event_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 7, 12, 0, 0)'}),
        ...
        'spa.mix': {
            ...
            'upload_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 12, 0, 0)'}),
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 12, 0, 0)'}),

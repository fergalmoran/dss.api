...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('spa_userprofile_followers', (
        ...
        db.create_unique('spa_userprofile_followers', ['from_userprofile_id', 'to_userprofile_id'])
    ...
    models = {
        ...
        'spa.event': {
            ...
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 4, 0, 0)'}),
            'event_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 4, 0, 0)'}),
            ...
            'event_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2013, 8, 4, 0, 0)'}),
        ...
        'spa.mix': {
            ...
            'upload_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 4, 0, 0)'}),
        ...
        'spa.release': {
            ...
            'release_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 4, 0, 0)'}),

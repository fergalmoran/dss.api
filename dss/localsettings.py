...
SOCIAL_AUTH_FACEBOOK_KEY = os.environ.get('MANDRILL_API_KEY', '')
SOCIAL_AUTH_FACEBOOK_SECRET = os.environ.get('MANDRILL_API_KEY', '')

SOCIAL_AUTH_TWITTER_KEY = os.environ.get('MANDRILL_API_KEY', '')
SOCIAL_AUTH_TWITTER_SECRET = os.environ.get('MANDRILL_API_KEY', '')

SOCIAL_AUTH_GOOGLE_OAUTH_KEY = os.environ.get('MANDRILL_API_KEY', '')
SOCIAL_AUTH_GOOGLE_OAUTH_SECRET = os.environ.get('MANDRILL_API_KEY', '')

SOCIAL_AUTH_GOOGLE_PLUS_KEY = os.environ.get('MANDRILL_API_KEY', '')
SOCIAL_AUTH_GOOGLE_PLUS_SECRET = os.environ.get('MANDRILL_API_KEY', '')

DSS_DB_BACKUP_KEY = os.environ.get('MANDRILL_API_KEY', '')
DSS_DB_BACKUP_SECRET = os.environ.get('MANDRILL_API_KEY', '')
DSS_DB_BACKUP_TOKEN = os.environ.get('MANDRILL_API_KEY', '')

AZURE_ACCOUNT_KEY = os.environ.get('MANDRILL_API_KEY', '')
